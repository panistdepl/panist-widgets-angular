app.controller('PanistsearchCtrl', ['$scope', '$rootScope', 'panistSearchService', function ($scope, $rootScope, panistSearchService) {
    ...
    if ($rootScope.panistConfigDefault.advancedToLoad){
        $scope.advancedQuery = $rootScope.panistConfigDefault.advancedToLoad;
    }

    if($rootScope.panistConfigDefault.query !== false) {
        var q = $rootScope.panistConfigDefault.query;
    ...
    $scope.search = function(){
        ...
        if (panistSearchService.search($scope) == false) {
            $rootScope.showLoading = false;
            $rootScope.showSelectEtab=true;
        }
        else {
        panistSearchService.search($scope)
            .success(function (result) {
                $rootScope.showError = false;
                $rootScope.showSelectEtab=false;
    ...
    if($rootScope.panistConfigDefault.advancedExpanded){
