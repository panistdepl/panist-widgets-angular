app.run(['$rootScope', function($rootScope) {
    ...
    $rootScope.panistConfigDefault = {
        // l'adresse de l'API de l'PANIST
        panistApi: 'https://api.panist.fr',
    ...
    if(window.panistConfig) {
        if (Object.getOwnPropertyNames(window.panistConfig).length > 0) {
            $rootScope.panistConfigDefault = extend($rootScope.panistConfigDefault, window.panistConfig);
