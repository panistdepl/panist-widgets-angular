                    ...
                    '<div class="downloads">'+
                        '<div class="download fulltext" ng-show="showFulltext">'+
                            ...
                            '<ul class="panist-results-item-download">'+
                                '<li class="panist-results-item-dl fulltext" ng-repeat="fulltext in document.fulltext">'+
                                    '<a ng-href="{{ fulltext.uri | sidize | proxify:panistConfigDefault.proxyApi }}" class="panist-results-item-dl-{{ fulltext.extension }}" title="Télécharger le fichier {{ fulltext.extension | uppercase }}" target="_blank">{{ fulltext.extension | uppercase }}</a>'+
                                '</li>'+
                            '</ul>'+
                        '</div>'+
                        '<div class="download metadata" ng-show="showMetadonnee">'+
                            ...
                            '<ul class="panist-results-item-download metadata">'+
                                '<li class="panist-results-item-dl" ng-repeat="metadata in document.metadata">'+
                                    '<a ng-href="{{ metadata.uri | sidize | proxify:panistConfigDefault.proxyApi }}" class="panist-results-item-dl-{{ metadata.extension }}" title="Télécharger le fichier {{ metadata.extension | uppercase }}" target="_blank">{{ metadata.extension | uppercase }}</a>'+
                                '</li>'+
                            '</ul>'+
                        '</div>'+
