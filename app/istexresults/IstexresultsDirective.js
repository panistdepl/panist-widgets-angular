app.directive('istexResults', function () {
    return {
        template: '' +
            ...
            '</div>' +
            '<div class="istex-results-error" ng-show="showSelectEtab">' +
            ...
            '<div class="downloads">' +
            '<div ng-show="showFulltext" class="download fulltext">' +
            ...
            '</ul>' +
            '</div>' +
            '<div ng-show="showMetadonnee" class="download metadata">' +
